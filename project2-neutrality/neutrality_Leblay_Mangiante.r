...
maf=read.table(gzfile(MAF,"r"),stringsAsFactors=F,header=T,sep="\t")
print(head(maf))
...
R2 = all_r2
save(R2,file = paste("R2_",strsplit(strsplit(MAF,"/")[[1]][5],"mutect")[[1]][1],".Rdata", sep=""))
A = all_a
save(A,file = paste("a_",strsplit(strsplit(MAF,"/")[[1]][5],"mutect")[[1]][1],".Rdata", sep=""))
